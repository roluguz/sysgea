...
<div class="register-box">
  <div class="register-logo">
    <a href="login.php"><b>SISGEA</b></a>
  </div>
  <div class="register-box-body">
    <p class="login-box-msg">Nuevo registro</p>   
    <form action="../Controllers/registroController.php" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="usuario" class="form-control" placeholder="Usuario de conexion" id="usuario" readonly> 
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Repite contraseña" id="strPassword2" required>
