...
?>
    <div class="box box-default">
      <div class="box-header with-border">
        <h1>Gesti&oacute;n postgrados</h1>
      </div>
      <div class="row">
        ...
        <div class="col-md-4">
          <?php
          $cod    = "";
          $btnnew  = "<a class='btn btn-success btn-block btn-flat' title='Adicionar un postgrados' ";
          $btnnew .= "type='button' datacode='new' href='?page=frmgralspecial&op=4'";
          $btnnew .= ">Agregar postgrados</a>";
          echo $btnnew;
          ?>
        </div>
...
<?php
  ...
  case 2: // Borrar
    ...
    $nnn = 'erase';
    $strAction = "Borrar";
    $tit   = "Borrar postgrados Asesores";
  ...
  case 3:  // Editar
    $nnn = 'edita';
    $strAction = "Editar";
    $tit   = "Edici&oacute;n postgrados Asesores";
  ...
  case 4: // Nuevo registro, revisar     
    $nnn = 'new';
    $strAction = "Nuevo";
    $tit   = "Adici&oacute;n postgrados Asesores";
